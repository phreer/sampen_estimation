...
if __name__ == '__main__':
    for m in range(3, 7):
        with open('result/wsl/process/219_sample-num_sample_size_m{}.csv'.format(m)) as f:
            lines = f.readlines()
        ...
        plt.legend(rel_errs)
        plt.savefig('result/wsl/process/fig/219_sample-num_sample-size_m{}.pdf'.format(m))
        plt.show()